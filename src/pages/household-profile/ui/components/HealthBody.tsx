...
import { FormField, Select, ToggleField } from "@shared/ui";
...
export default function HealthBody() {
  ...
  const { control } = useFormContext<Health>();
  ...
  return (
    <div className="flex-1 p-6 space-y-6 overflow-y-auto">
      <div className="mx-auto space-y-14 px-17 py-13 md:px-16 md:py-12">
            ...
            {insuraneOn && (
              <Select
                options={[
                  ...
                  { labelEn: "Private Insurance", value: "private" },
        ...
        <section className="space-y-6 w-full">
          <h3 className="text-xs font-medium text-ink-500 uppercase tracking-wide border-b border-ink-200 pb-2">
            Section 03: Chronic Illnesses (दीर्घरोगहरू)
          </h3>
          <div className="flex flex-col gap-6">
            <ToggleField
              label={"Any family member has chronic illness?"}
              labelSuffix={"परिवारमा कुनै दीर्घरोगी छ?"}
